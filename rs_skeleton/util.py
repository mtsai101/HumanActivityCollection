...
class JointWriter():
    ...
    def write_skeleton(self, skeletons):
        with open(self.output_path, 'a') as f:
            data = {self.time_stamp: skeletons}
            json.dump(data, f)
